...
def generateModel(num_emotion=7):
    return Sequential(
        [
            ...
            layers.Conv2D(filters=num_classes, kernel_size=(3, 3), activation='relu'),
            layers.Conv2D(filters=num_classes, kernel_size=(3, 3), activation='relu', padding='SAME'),
            layers.BatchNormalization(),
            layers.MaxPool2D(pool_size=(2, 2), strides=(2, 2)),
            layers.Dropout(0.5),

            layers.Conv2D(filters=2*num_classes, kernel_size=(3, 3), activation='relu', padding='SAME'),
            layers.BatchNormalization(),
            layers.Conv2D(filters=2*num_classes, kernel_size=(3, 3), activation='relu', padding='SAME'),
            layers.BatchNormalization(),
            layers.MaxPool2D(pool_size=(2, 2), strides=(2, 2)),
            ...
            layers.Conv2D(filters=2*2*num_classes, kernel_size=(3, 3), activation='relu', padding='SAME'),
            layers.BatchNormalization(),
            layers.Conv2D(filters=2*2*num_classes, kernel_size=(3, 3), activation='relu', padding='SAME'),
            layers.BatchNormalization(),
            layers.MaxPool2D(pool_size=(2, 2), strides=(2, 2)),
            ...
            layers.Conv2D(filters=2*2*2*num_classes, kernel_size=(3, 3), activation='relu', padding='SAME'),
            layers.BatchNormalization(),
            layers.Conv2D(filters=2*2*2*num_classes, kernel_size=(3, 3), activation='relu', padding='SAME'),
            layers.BatchNormalization(),
            layers.MaxPool2D(pool_size=(2, 2), strides=(2, 2)),
            ...
            layers.Dense(units=2*2*2*num_classes, activation='relu'),
            layers.BatchNormalization(),
            layers.Dropout(rate=0.2),
            layers.Dense(units=2*2*num_classes, activation='relu'),
            layers.Dropout(rate=0.2),
            layers.Dense(units=2*num_classes, activation='relu'),
