...
CONVERSION_DICT = {3: 0, 4: 2, 0: 1, 5: 3}
EMOTION_CLASSIFICATION_REDUCED = {0: 'Happy', 1: 'Angry', 2: 'Sad', 3: 'Surprise'}
...
def get_data(train_data_file_paths: list = train_filepath,
    ...
    train_data = train_data[train_data['emotion'].isin([3, 4, 0, 5])]
    train_data['emotion'] = train_data['emotion'].replace(CONVERSION_DICT)

    val_data = val_data[val_data['emotion'].isin([3, 4, 0, 5])]
    ...
    test_data = test_data[test_data['emotion'].isin([3, 4, 0, 5])]
