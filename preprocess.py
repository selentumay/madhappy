...
CONVERSION_DICT = {3: 0, 4: 1, 5: 2}
EMOTION_CLASSIFICATION_REDUCED = {0: 'Happy', 1: 'Sad', 2: 'Surprise'}
...
def get_data(train_data_file_paths: list = train_filepath,
    ...
    train_data = train_data[train_data['emotion'].isin([3, 4, 5])]
    train_data['emotion'] = train_data['emotion'].replace(CONVERSION_DICT)

    val_data = val_data[val_data['emotion'].isin([3, 4, 5])]
    ...
    test_data = test_data[test_data['emotion'].isin([3, 4, 5])]
